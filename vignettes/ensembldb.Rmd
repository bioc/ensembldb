...
(see Section [11](#org25ef869) for the database layout and an overview of
...
# Database layout<a id="org25ef869"></a>

The database consists of the following tables and attributes (the layout is also
shown in Figure [156](#org38c3975)). Note that the protein-specific annotations
